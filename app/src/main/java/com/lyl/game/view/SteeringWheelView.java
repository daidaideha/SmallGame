...
public class SteeringWheelView extends View {
     ...
     * 当前方向
     */
    private GameDirection mDirection = GameDirection.INVALID;
    /**
     * 向右箭头
     */
    ...
    private void init(AttributeSet attrs, int defStyle) {
        ...
        mDefaultWidth = DensityUtil.dip2px(mDefaultWidthDp);
        mDefaultHeight = DensityUtil.dip2px(mDefaultHeightDp);
    ...
    public interface SteeringWheelListener {
         ...
         */
        void onStatusChanged(SteeringWheelView view, int angle, int power, GameDirection direction);
    }
}
